...
import Jardineria.View.CantidadCondicionActualController;
import Jardineria.View.CantidadFotoController;
import Jardineria.View.CantidadRiegoDiaController;
import Jardineria.View.CantidadRiegoFecha;
import Jardineria.View.CantidadRiegoProgramadoController;
...
public class Main extends Application {
	...
	public void Ventana1() {
		try {
			...
			stageTipoProducto.setScene(scene);
			stageTipoProducto.initModality(Modality.WINDOW_MODAL);
			ProductoTPController pTP = loader.getController();
			pTP.setMain(this);
			stageTipoProducto.show();
		} catch(Exception e) {
			e.printStackTrace();
	...
	public void Ventana2() {
		try {
			...
			stageTipoProducto.setScene(scene);
			stageTipoProducto.initModality(Modality.WINDOW_MODAL);
			CantidadRiegoFecha controlerG = loader.getController();
			controlerG.setMain(this);
			stageTipoProducto.show();
		} catch(Exception e) {
			e.printStackTrace();
	...
	public void Ventana3() {
		try {
			...
			stageTipoProducto.setScene(scene);
			stageTipoProducto.initModality(Modality.WINDOW_MODAL);
			CantidadCondicionActualController  cCA= loader.getController();
			cCA.setMain(this);
			stageTipoProducto.show();
		} catch(Exception e) {
			e.printStackTrace();
	...
	public void Ventana4() {
		try {
			...
			stageTipoProducto.setScene(scene);
			stageTipoProducto.initModality(Modality.WINDOW_MODAL);
			CantidadFotoController cF = loader.getController();
			cF.setMain(this);
			stageTipoProducto.show();
		} catch(Exception e) {
			e.printStackTrace();
	...
	public void Ventana5() {
		try {
			...
			stageTipoProducto.setScene(scene);
			stageTipoProducto.initModality(Modality.WINDOW_MODAL);
			CantidadRiegoDiaController cRD = loader.getController();
			cRD.setMain(this);
			stageTipoProducto.show();
		} catch(Exception e) {
			e.printStackTrace();
	...
	public void Ventana6() {
		try {
			...
			stageTipoProducto.setScene(scene);
			stageTipoProducto.initModality(Modality.WINDOW_MODAL);
			CantidadRiegoProgramadoController cRP = loader.getController();
			cRP.setMain(this);
			stageTipoProducto.show();
		} catch(Exception e) {
			e.printStackTrace();
